...
import com.thtf.app.web.rest.errors.EmailNotFoundException;
import com.thtf.app.web.rest.errors.InternalServerErrorException;
import com.thtf.app.web.rest.errors.InvalidPasswordException;
import com.thtf.app.web.rest.errors.LoginAlreadyUsedException;
import com.thtf.app.web.rest.vm.KeyAndPasswordVM;
import com.thtf.app.web.rest.vm.ManagedUserVM;
...
//	}
	 ...
	 */
	@GetMapping("/accountold")
	@Timed
	public UserDTO getAccountOld() {
		return userService.getUserWithAuthoritiesO().map(u -> new UserDTO(u.getId(), u.getLogin(), u.getRealName(), u.getEmail(), u.getActivated(), u.getImageUrl(), u.getLangKey(), u.getCreatedBy(),
				u.getCreatedDate(), u.getLastModifiedBy(), u.getLastModifiedDate(),
				u.getAuthorities().stream().map(Authority::getName).collect(Collectors.toSet()),
				null,
//				u.getRoles().stream()
...
//						.collect(Collectors.toSet()),
	...
	public UserDTO getAccount() {
		return userService.getUserDTOWithAuthorities();
	}
	...
	public void saveAccount(@Valid @RequestBody UserDTO userDTO) {
		...
		userService.updateUser(userDTO.getRealName(), userDTO.getEmail(), userDTO.getLangKey(),
				userDTO.getImageUrl());
	}
