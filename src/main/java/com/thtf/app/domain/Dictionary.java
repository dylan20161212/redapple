...
public class Dictionary extends AbstractAuditingEntity implements Serializable {
    ...
    @NotNull
    @Size(max = 255)
    @Column(name = "dic_value", length = 255, nullable = false)
    private String dicValue;

    @Size(max = 255)
    @Column(name = "dic_flag", length = 255)
    ...
    public Dictionary dicLft(Integer dicLft) {
        this.dicLft = dicLft;
        return this;
    }
    ...
    public Dictionary dicRgt(Integer dicRgt) {
        this.dicRgt = dicRgt;
        return this;
    }
